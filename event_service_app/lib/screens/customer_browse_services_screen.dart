...
class _NavigationHelper {
  static Future<void> navigateToServiceDetail(BuildContext context, String serviceId) async {
    try {
      ...
      if (serviceDoc.exists && context.mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => ServiceDetailScreen(serviceDoc: serviceDoc),
          ),
        );
...
class CustomerBrowseServicesScreen extends StatefulWidget {
  ...
  @override
  CustomerBrowseServicesScreenState createState() =>
      CustomerBrowseServicesScreenState();
}

class CustomerBrowseServicesScreenState
...
// Recommended Services Section Widget
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final service = recommendations[index];
                    return RecommendedServiceCard(service: service);
                  },
                ),
              ),
            ],
...
class RecommendedServiceCard extends StatelessWidget {
  ...
  const RecommendedServiceCard({super.key, required this.service});
    ...
    return Container(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(12),
            onTap: () => _NavigationHelper.navigateToServiceDetail(context, service['id'] as String),
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Price
                Text(
                  'RM ${(service['price'] as num?)?.toStringAsFixed(2) ?? '0.00'}',
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
                    color: Theme.of(context).colorScheme.primary,
                ...
                if (service['recommendationReason'] != null)
                  Container(
                    ...
                    child: Text(
                      service['recommendationReason'] as String,
                      style: TextStyle(
                        fontSize: 10,
